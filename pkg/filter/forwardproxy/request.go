...
func (f *ForwardProxy) prepareRequest(ctx context.HTTPContext, address string, reqBody io.Reader, requestPool, httpStatResultPool *sync.Pool)  (req *request, err error) {
